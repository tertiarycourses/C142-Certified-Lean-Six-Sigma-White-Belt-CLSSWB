# Certified Lean Six Sigma White Belt (CLSSWB) — Learner Guide

**Course Code:** C142  |  **Conducted by:** Tertiary Infotech Academy Pte Ltd (UEN 201200696W)  |  **Version v3 · 23 September 2026**
...
- [FOUNDATIONS — Lean Six Sigma Foundations  (20%)](#foundations--lean-six-sigma-foundations--20)
- [DEFINE — Define — Understand the Problem  (20%)](#define--define--understand-the-problem--20)
  - [Activity 1 — Define — Customer Requirements and the Problem Statement  [Core]](#activity-1--define--customer-requirements-and-the-problem-statement--core)
- [MEASURE — Measure — See What Is Really Happening  (20%)](#measure--measure--see-what-is-really-happening--20)
  - [Activity 2 — Measure — Map the Process and Spot the Waste  [Core]](#activity-2--measure--map-the-process-and-spot-the-waste--core)
- [ANALYZE — Analyze — Find the Cause  (20%)](#analyze--analyze--find-the-cause--20)
  - [Activity 3 — Analyze — Find the Root Cause  [Core]](#activity-3--analyze--find-the-root-cause--core)
- [IMPROVE — Improve — Fix the Cause  (10%)](#improve--improve--fix-the-cause--10)
  - [Activity 4 — Improve — Choose and Pilot a Countermeasure  [Core]](#activity-4--improve--choose-and-pilot-a-countermeasure--core)
- [CONTROL — Control — Hold the Gain  (10%)](#control--control--hold-the-gain--10)
  - [Activity 5 — Control — Hold the Gain and Hand Over  [Core]](#activity-5--control--hold-the-gain-and-hand-over--core)
- [Quick Reference — The DMAIC Roadmap](#quick-reference--the-dmaic-roadmap)
...
This Learner Guide accompanies the course Certified Lean Six Sigma White Belt (CLSSWB) (C142), conducted by Tertiary Infotech Academy Pte Ltd. This is a one-day Lean Six Sigma awareness course. It follows the DMAIC roadmap end to end — Define, Measure, Analyze, Improve, Control — with one hands-on activity in each of the five phases, and provides step-by-step instructions for every activity.

The course content is grounded in the body of knowledge published by The Council for Six Sigma Certification (CSSC) in 'Six Sigma: A Complete Step-by-Step Guide', so what you learn here matches the recognised White Belt standard.

As a White Belt you are being prepared to CONTRIBUTE to an improvement team — to understand the language, recognise waste, and support the tools your team uses. You are not expected to lead a project or perform the statistical analysis; those belong to the Yellow, Green and Black Belt levels.

Every activity uses one continuous scenario — the BrewBean Cafe morning rush, where customers queue up to 15 minutes and orders are sometimes made wrong. By the end of the day your five activity outputs form a complete improvement story: customer requirements and problem statement, process map and waste tally, root cause analysis, a selected countermeasure with a pilot plan, and a control plan.
...
Two browser-based tools are used during the activities. No installation or licence is required.
...
**How the five activities fit together**
...
- Every activity is completed by everyone, and all five map directly to the DMAIC roadmap.
...
## FOUNDATIONS — Lean Six Sigma Foundations  (20%)
...
## DEFINE — Define — Understand the Problem  (20%)

Voice of the Customer · CTQ · Problem statement · SMART goal · Project charter
...
### Activity 1 — Define — Customer Requirements and the Problem Statement  [Core]

Objective: Identify customer requirements and write a clear problem statement (A1, A2).

Goal: Start the BrewBean Cafe improvement the way every real project starts: find out what the customer actually wants, turn that into something measurable, and state the problem clearly enough that everyone agrees on it. The most common reason improvement projects fail is that the team never agreed what the problem was.
...
## MEASURE — Measure — See What Is Really Happening  (20%)

Process mapping · SIPOC · Types of data · Data collection · The eight wastes
...
### Activity 2 — Measure — Map the Process and Spot the Waste  [Core]

Objective: Describe how the process runs and identify the eight wastes in it (A4, K2).

Goal: You cannot improve what you cannot see. Walk the BrewBean Cafe morning rush from the customer joining the queue to the drink being handed over, draw it as it really happens, and tally where time and effort are being lost. This is the phase that turns opinions about the problem into facts about the problem.
...
7. Identify which single waste type you tallied most often and at which process step, then write down the baseline figures (average wait, longest wait, % over the 5-minute promise, drinks remade) — Activity 5 measures the improvement against them.
...
## ANALYZE — Analyze — Find the Cause  (20%)

Root cause · 5 Whys · Fishbone diagram · Pareto chart · Variation
...
### Activity 3 — Analyze — Find the Root Cause  [Core]

Objective: Identify likely causes using 5 Whys and Fishbone analysis (A3, K2).

Goal: You now know WHERE the delay happens. This activity asks WHY it happens. Most teams jump straight from a symptom to a solution and end up fixing the wrong thing — the queue is long, so hire more staff — when the real cause was something else entirely. Here you drill past the symptom to a cause you can actually act on.
...
1. Write the symptom from your Activity 2 baseline at the top of templates/5-whys-template.csv (e.g. 'customers wait an average of 8.9 minutes against a 5-minute promise').
...
5. Open data/delay-reason-pareto-data.csv — the delay reasons from the Activity 2 log, counted and ranked. Read the Cumulative % column and state which few causes account for most of the problem.
...
Generating solutions · 5S · Mistake proofing · Standard work · Piloting
...
### Activity 4 — Improve — Choose and Pilot a Countermeasure  [Core]

Objective: Describe improvement actions that address the identified cause (A5, K2).

Goal: A cause is only worth finding if something changes because of it. Take the root causes you shortlisted in Activity 3, generate countermeasures against them, and pick one that is small enough to try next week. The discipline here is to solve the CAUSE you proved, not the symptom you started with.
...
- DATA — Pilot week results (6 rows): What actually happened when the chosen countermeasure was piloted for one week. The same 60-customer observation was repeated each day. Used in Step 7 to judge whether the pilot worked, and carried into Activity 5 as the new baseline.
...
1. Write your top root cause from Activity 3 at the top of templates/countermeasure-brainstorm-template.csv — every idea must address THIS cause.
...
Your selected countermeasure clearly addresses the root cause from Activity 3 (not the symptom), and your pilot plan names a measure, an owner and a review date.
...
Control plan · Visual management · SOPs · Team huddles · Handover
...
### Activity 5 — Control — Hold the Gain and Hand Over  [Core]

Objective: Describe the control actions that sustain an improvement (A5, K2).

Goal: Most improvements work for a fortnight and then quietly disappear. Control is what stops that happening. Close the BrewBean Cafe story by deciding what will be measured from now on, who owns it, what happens when it slips, and how the improved process is handed back to the people who run it every day.
...
5. In templates/sop-and-huddle-template.csv, turn your Activity 4 standard work into a short SOP the cafe could actually pin up.
...
## Quick Reference — The DMAIC Roadmap

**What each phase asks, and what it delivers**
...
**A note on Six Sigma measurement**

You will hear practitioners refer to a process's 'sigma level' and to DPMO (Defects Per Million Opportunities) — the measure Six Sigma uses to describe how often a process produces a defect. The well-known Six Sigma target is 3.4 defects per million opportunities, which is why the method carries that name.

As a White Belt you are expected to RECOGNISE these terms and understand what they describe. Calculating DPMO and converting it to a sigma level is done at Yellow Belt and above, and is not assessed on this course.
...
- Keep these slides, this Learner Guide and your activity outputs — they are your reference after the course.
- Re-read your own activity outputs; they follow one continuous scenario from Define through to Control.
