"""Topic 3 — Measure (DMAIC · MEASURE). Labs: 2. Continues the BrewBean Cafe running scenario.
...
DOMAIN3 = [
    dict(
        ...
        objective="Describe how the process runs and identify the eight wastes in it.",
