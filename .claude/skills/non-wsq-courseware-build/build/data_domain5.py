"""Topic 5 — Improve (DMAIC · IMPROVE). Labs: 4. Continues the BrewBean Cafe running scenario.
...
DOMAIN5 = [
    dict(
        ...
        objective="Describe improvement actions that address the identified cause.",
