...
## Frameworks used in the activities

| Framework | What it does | Used in |
|---|---|---|
...
These browser-based tools are free and need no installation or licence.

| Tool | What it does |
|---|---|
| [5 Whys](https://alfredang.github.io/5whys/) | Build and share a 5 Whys root-cause chain |
| [Fishbone Diagram](https://alfredang.github.io/fishbone/) | Build an Ishikawa cause-and-effect diagram |
| [Pareto Chart](https://alfredang.github.io/paretochart/) | Collaborative brainstorm, vote, and a live Pareto chart |
| [NovaSPC](https://alfredang.github.io/novaspc/) | Run charts, SPC charts and process capability from your own CSV |

## The eight wastes — DOWNTIME

| Letter | Waste | What it looks like at BrewBean Cafe |
|---|---|---|
...
| Phase | The question it asks | What it delivers |
|---|---|---|
...
*Certified Lean Six Sigma White Belt (CLSSWB) · C142 · © 2026 Tertiary Infotech Academy Pte Ltd*
