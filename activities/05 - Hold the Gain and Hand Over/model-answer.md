...
DEFINE   — VOC from 30 customer comments; CTQ 'served within 5 minutes'; problem:
           waits up to 15.0 min against a 5-min promise over two months.
MEASURE  — 60 customers observed; average wait 8.9 min; 82% over
           the promise; largest wastes Waiting and Motion; 18 mid-order milk trips.
ANALYZE  — Pareto: Waiting for milk restock and Single till queue = 56.1% of delays.
...
RESULT   — Average morning wait reduced from 8.9 min to about 6.0 min, a
