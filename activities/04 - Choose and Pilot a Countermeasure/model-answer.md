...
BASELINE TO BEAT: 8.9 min average wait, 18 milk trips, 7 remakes.
...
```
Baseline:  8.9 min average, 18 milk trips, 7 remakes.
Mon 8.4 / Tue 7.1 / Wed 6.3 / Thu 9.8 / Fri 6.0 min.
Average across the pilot week: 7.5 min — a fall of about 5.4 minutes, roughly 42%.
Mid-order milk trips fell from 18 to 0-7 per morning; remakes fell from 7 to 3-6.
